  /* ============ מסך הפתיחה: גלגל שנופל, מקפיץ, ומתגלגל ============
   ...
   האור על הגומי אינו מסתובב. בקובץ הוא היה אפוי בתמונה, וכשהתמונה
   מסתובבת מסתובב איתה גם האור — זה הסימן הכי חזק לכך שמסתובבת
   תמונה ולא גוף. לכן הוצאנו מהקובץ את הרכיב הזוויתי של הבהירות
   (18% ברנדר) והחזרנו אותו כשכבה שאינה מסתובבת: מואר מלמעלה, כהה
   מלמטה. מה שמסתובב זה הפרוטקטור והכיתוב, כמו במציאות.
