...
(function () {
  ...
  var PROF = [
    [0.000, 0.296], [0.100, 0.290], [0.190, 0.269], [0.300, 0.258],
    [0.430, 0.270], [0.530, 0.300], [0.585, 0.340], [0.625, 0.369],
    [0.700, 0.394], [0.790, 0.408], [0.870, 0.414], [0.930, 0.410],
    [0.972, 0.399], [1.000, 0.383]
  ];
  var BAND_Z = [0.383, 0.230, 0.077, -0.077, -0.230, -0.383];
  ...
  var FS = [
    ...
    '    float alb = mix(0.017, 0.094, blk) * sh;',
    '    vec3 H = normalize(L + V);',
  ...
  window.createWheel3D = function (canvas, texUrl, margin) {
    ...
    var half = margin * (1 + 0.38 / CAM) * 1.037;
